##################################################################
# Code from:                                                     #
# Christof Weiß and Geoffroy Peeters. "Training Deep Pitch-Class #
#  Representations With a Multi-Label CTC Loss", Proceedings of  #
...
class basic_cnn_segm_sigmoid(torch.nn.Module):
    ...
    """
    def __init__(self, n_chan_input=6, n_chan_layers=[20,20,10,1], n_bins_in=216, n_bins_out=12, a_lrelu=0.3, p_dropout=0.2, n_ch_out=None):
